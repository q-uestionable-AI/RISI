...
findings. The repository implements a deterministic safe baseline, one intentionally controlled
synthetic CRAF mechanism with a protected control, and one controlled four-arm RISI-C reference
comparison with a pure-read ablation. It does not demonstrate an external vulnerability.
...
- [Quickstart](/quickstart) — execute the DEP-01 and DEP-02 reference comparisons.
...
- [Controlled RISI-C reference](/risi-c-reference) — understand the four-arm design and evidence.
