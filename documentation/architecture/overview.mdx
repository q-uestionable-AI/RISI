...
pinned HTTPS target, separate PBKDF2-SHA256 API and health credential verifiers, a closed Dify
Knowledge API allowlist, exact campaign and input-inventory digests, purpose, expiry, attempt
ceiling, and
zero retries. E2
